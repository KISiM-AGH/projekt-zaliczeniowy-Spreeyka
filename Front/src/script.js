...
function main() {
  ...
  function selectTime() {
    let file = document.querySelector("#time-input").files[0];
    let timeContainer = document.querySelector(".time__container");
    let reader = new FileReader();
    reader.addEventListener("load", function (e) {
      var text = document.createTextNode(e.target.result);
  ...
  timeButton.addEventListener("click", () => selectTime());
